...
gsutil -o 'GSUtil:parallel_process_count=1' -o 'GSUtil:parallel_thread_count=16' -m cp -r "gs://assistive-gym-experiments/rss-logs/logs/output/210208/ppo/BedBathingJacoHuman-v1-skip5-v0208_h*" "new_models/210208/ppo/"
